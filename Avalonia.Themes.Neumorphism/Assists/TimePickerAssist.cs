...
namespace Avalonia.Themes.Neumorphism.Assist
{
    ...
    {
        //public static AvaloniaProperty<bool> UseFloatingWatermarkProperty = AvaloniaProperty.RegisterAttached<ExtendedTimePicker, bool>("UseFloatingWatermark", typeof(TimePickerAssist));
