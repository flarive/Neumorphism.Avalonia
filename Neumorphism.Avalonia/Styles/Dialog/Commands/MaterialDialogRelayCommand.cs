...
namespace Neumorphism.Avalonia.Styles.Dialog.Commands
{
    /// <summary>
    /// Do not use it in your project! It should be used only inside of Neumorphism.Avalonia.Styles.Dialog.<br/>
